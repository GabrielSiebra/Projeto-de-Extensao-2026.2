...
function classNames() {
	...
	if (args) {
		...
		for (var i = 0; i < args.length; i++) {
			...
			var type = _typeof$5(className);
			if (type === "string" || type === "number") classes.push(className);
			else if (type === "object") {
				var _classes = Array.isArray(className) ? className : Object.entries(className).map(function(_ref) {
					var _ref2 = _slicedToArray$5(_ref, 2), key = _ref2[0];
	...
	return _createClass$1(DomHandler, null, [
		...
		},
		{
			...
			value: function isElement(obj) {
				return (typeof HTMLElement === "undefined" ? "undefined" : _typeof$5(HTMLElement)) === "object" ? obj instanceof HTMLElement : obj && _typeof$5(obj) === "object" && obj !== null && obj.nodeType === 1 && typeof obj.nodeName === "string";
			}
		},
		{
			key: "isDocument",
			value: function isDocument(obj) {
				return (typeof Document === "undefined" ? "undefined" : _typeof$5(Document)) === "object" ? obj instanceof Document : obj && _typeof$5(obj) === "object" && obj !== null && obj.nodeType === 9;
			}
		},
		{
			key: "scrollInView",
		...
		},
		{
			...
			value: function addNonce(styleElement, nonce) {
				try {
					if (!nonce) nonce = processModule.env.REACT_APP_CSS_NONCE;
				} catch (error) {}
		...
		},
		{
			...
			value: function getTargetElement(target) {
				...
				else if (_typeof$5(target) === "object" && target.hasOwnProperty("current")) return this.isExist(target.current) ? target.current : null;
...
*/
_defineProperty$5(DomHandler, "DATA_PROPS", ["data-"]);
/**
* All ARIA properties like aria-label and focus-target for https://www.npmjs.com/package/@q42/floating-focus-a11y
*/
_defineProperty$5(DomHandler, "ARIA_PROPS", ["aria", "focus-target"]);
function _extends$4() {
	...
	return _createClass$1(ObjectUtils, null, [
		{
			...
			value: function equals(obj1, obj2, field) {
				if (field && obj1 && _typeof$5(obj1) === "object" && obj2 && _typeof$5(obj2) === "object") return this.deepEquals(this.resolveFieldData(obj1, field), this.resolveFieldData(obj2, field));
		...
		},
		{
			...
			value: function getRefElement(ref) {
				if (ref) return _typeof$5(ref) === "object" && ref.hasOwnProperty("current") ? ref.current : ref;
				return null;
			}
		},
		{
		...
		},
		{
			...
			value: function mutateFieldData(data, field, value) {
				if (_typeof$5(data) !== "object" || typeof field !== "string") return;
				var fields = field.split(".");
				var obj = data;
				for (var i = 0, len = fields.length; i < len; ++i) {
					if (i + 1 - len === 0) {
		...
		},
		{
			...
			value: function absoluteCompare(objA, objB) {
				...
				if (_typeof$5(objA) !== _typeof$5(objB)) return false;
		...
		},
		{
			...
			value: function selectiveCompare(a, b, keysToCompare) {
				...
				if (a === b) return true;
				if (!a || !b || _typeof$5(a) !== "object" || _typeof$5(b) !== "object") return false;
				...
				try {
					for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
						...
						var isObject = _typeof$5(aValue) === "object" && aValue !== null && _typeof$5(bValue) === "object" && bValue !== null;
...
var IconUtils = /*#__PURE__*/ function() {
	...
	return _createClass$1(IconUtils, null, [{
		...
		value: function getJSXIcon(icon) {
			...
			var content = null;
			if (icon !== null) {
				var iconType = _typeof$5(icon);
				var className = classNames(iconProps.className, iconType === "string" && icon);
				content = /*#__PURE__*/ import_react.createElement("span", _extends$4({}, iconProps, {
					className,
...
function mergeProps(props) {
	...
	return props.reduce(function(merged, ps) {
		...
		var _loop = function _loop() {
			var value = ps[key];
			if (key === "style") merged.style = _objectSpread$5(_objectSpread$5({}, merged.style), ps.style);
...
_defineProperty$4(PrimeReact$1, "pt", void 0);
...
var PrimeReactProvider = function PrimeReactProvider(props) {
	...
	var _useState2 = _slicedToArray$4((0, import_react.useState)((_propsValue$ripple = propsValue.ripple) !== null && _propsValue$ripple !== void 0 ? _propsValue$ripple : false), 2), ripple = _useState2[0], setRipple = _useState2[1];
	var _useState4 = _slicedToArray$4((0, import_react.useState)((_propsValue$inputStyl = propsValue.inputStyle) !== null && _propsValue$inputStyl !== void 0 ? _propsValue$inputStyl : "outlined"), 2), inputStyle = _useState4[0], setInputStyle = _useState4[1];
	var _useState6 = _slicedToArray$4((0, import_react.useState)((_propsValue$locale = propsValue.locale) !== null && _propsValue$locale !== void 0 ? _propsValue$locale : "en"), 2), locale = _useState6[0], setLocale = _useState6[1];
	var _useState8 = _slicedToArray$4((0, import_react.useState)((_propsValue$appendTo = propsValue.appendTo) !== null && _propsValue$appendTo !== void 0 ? _propsValue$appendTo : null), 2), appendTo = _useState8[0], setAppendTo = _useState8[1];
	var _useState10 = _slicedToArray$4((0, import_react.useState)((_propsValue$styleCont = propsValue.styleContainer) !== null && _propsValue$styleCont !== void 0 ? _propsValue$styleCont : null), 2), styleContainer = _useState10[0], setStyleContainer = _useState10[1];
	var _useState12 = _slicedToArray$4((0, import_react.useState)((_propsValue$cssTransi = propsValue.cssTransition) !== null && _propsValue$cssTransi !== void 0 ? _propsValue$cssTransi : true), 2), cssTransition = _useState12[0], setCssTransition = _useState12[1];
	var _useState14 = _slicedToArray$4((0, import_react.useState)((_propsValue$autoZInde = propsValue.autoZIndex) !== null && _propsValue$autoZInde !== void 0 ? _propsValue$autoZInde : true), 2), autoZIndex = _useState14[0], setAutoZIndex = _useState14[1];
	var _useState16 = _slicedToArray$4((0, import_react.useState)((_propsValue$hideOverl = propsValue.hideOverlaysOnDocumentScrolling) !== null && _propsValue$hideOverl !== void 0 ? _propsValue$hideOverl : false), 2), hideOverlaysOnDocumentScrolling = _useState16[0], setHideOverlaysOnDocumentScrolling = _useState16[1];
	var _useState18 = _slicedToArray$4((0, import_react.useState)((_propsValue$nonce = propsValue.nonce) !== null && _propsValue$nonce !== void 0 ? _propsValue$nonce : null), 2), nonce = _useState18[0], setNonce = _useState18[1];
	var _useState20 = _slicedToArray$4((0, import_react.useState)((_propsValue$nullSortO = propsValue.nullSortOrder) !== null && _propsValue$nullSortO !== void 0 ? _propsValue$nullSortO : 1), 2), nullSortOrder = _useState20[0], setNullSortOrder = _useState20[1];
	var _useState22 = _slicedToArray$4((0, import_react.useState)((_propsValue$zIndex = propsValue.zIndex) !== null && _propsValue$zIndex !== void 0 ? _propsValue$zIndex : {
		modal: 1100,
		overlay: 1e3,
		menu: 1e3,
		tooltip: 1100,
		toast: 1200
	}), 2), zIndex = _useState22[0], setZIndex = _useState22[1];
	var _useState24 = _slicedToArray$4((0, import_react.useState)((_propsValue$ptOptions = propsValue.ptOptions) !== null && _propsValue$ptOptions !== void 0 ? _propsValue$ptOptions : {
		mergeSections: true,
		mergeProps: true
	}), 2), ptOptions = _useState24[0], setPtOptions = _useState24[1];
	var _useState26 = _slicedToArray$4((0, import_react.useState)((_propsValue$pt = propsValue.pt) !== null && _propsValue$pt !== void 0 ? _propsValue$pt : void 0), 2), pt = _useState26[0], setPt = _useState26[1];
	var _useState28 = _slicedToArray$4((0, import_react.useState)((_propsValue$unstyled = propsValue.unstyled) !== null && _propsValue$unstyled !== void 0 ? _propsValue$unstyled : false), 2), unstyled = _useState28[0], setUnstyled = _useState28[1];
	var _useState30 = _slicedToArray$4((0, import_react.useState)((_propsValue$filterMat = propsValue.filterMatchModeOptions) !== null && _propsValue$filterMat !== void 0 ? _propsValue$filterMat : {
		text: [
			FilterMatchMode.STARTS_WITH,
			FilterMatchMode.CONTAINS,
			FilterMatchMode.NOT_CONTAINS,
	...
	}), 2), filterMatchModeOptions = _useState30[0], setFilterMatchModeOptions = _useState30[1];
...
//#endregion
export { PrimeReactProvider as n, Button as t };
